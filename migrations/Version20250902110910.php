 ...
 */
final class Version20250902110910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, table_id INT NOT NULL, quantites JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', date DATETIME NOT NULL, INDEX IDX_6EEAA67DECFF285C (table_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
